...
function SellerLogin(){
    ...
    async function signup(){
        ...
        try{
            ...
            const sellersCollectionRef =  doc(db, "sellers", auth.currentUser.uid)
            const uid = auth.currentUser.uid;
            await setDoc(sellersCollectionRef, { email:signupEmail, phone:signupPhonenumber,brand :brandName})
    ...
    async function signin(){
        try{
          ...
          const uid = auth.currentUser.uid;
          const sellersRef = doc(db, "sellers" , auth.currentUser.uid)
          const userData = await getDoc(sellersRef)
        ...
        if(userData.data()){
          ...
          alert("You do not have a seller account, please register first")
        }
...
<MDBTabsContent>
  ...
  <MDBTabsPane show={justifyActive === 'tab2'}>
    ...
    <MDBInput onChange={(e)=>{setBrandname(e.target.value)}} wrapperClass='mb-4' label='Name' id='form1' type='text'/>
